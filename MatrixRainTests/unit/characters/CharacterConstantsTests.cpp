...
namespace MatrixRainTests
{
    ...
    public:
        TEST_METHOD(KatakanaCodepoints_HasCorrectCount)
        {
            ...
            Assert::AreEqual(static_cast<size_t>(72), MatrixRain::CharacterConstants::KATAKANA_COUNT);
        }

        TEST_METHOD(KatakanaCodepoints_StartsWithCorrectValue)
        {
            // First katakana should be U+30A0
            Assert::AreEqual(static_cast<uint32_t>(0x30A0), MatrixRain::CharacterConstants::KATAKANA_CODEPOINTS[0]);
        }

        TEST_METHOD(KatakanaCodepoints_EndsWithCorrectValue)
        {
            // Last katakana should be U+30E7 (ョ Small Yo)
            size_t lastIndex = MatrixRain::CharacterConstants::KATAKANA_COUNT - 1;
            Assert::AreEqual(static_cast<uint32_t>(0x30E7), MatrixRain::CharacterConstants::KATAKANA_CODEPOINTS[lastIndex]);
        }

        TEST_METHOD(KatakanaCodepoints_AllInValidRange)
        {
            // All katakana should be in range U+30A0 to U+30FF
            for (size_t i = 0; i < MatrixRain::CharacterConstants::KATAKANA_COUNT; i++)
            {
                uint32_t cp = MatrixRain::CharacterConstants::KATAKANA_CODEPOINTS[i];
        ...
        TEST_METHOD(LatinUppercaseCodepoints_HasCorrectCount)
        {
            ...
            Assert::AreEqual(static_cast<size_t>(26), MatrixRain::CharacterConstants::LATIN_UPPERCASE_COUNT);
        }

        TEST_METHOD(LatinUppercaseCodepoints_StartsWithA)
        {
            // First should be 'A' (0x0041)
            Assert::AreEqual(static_cast<uint32_t>(0x0041), MatrixRain::CharacterConstants::LATIN_UPPERCASE_CODEPOINTS[0]);
        }

        TEST_METHOD(LatinUppercaseCodepoints_EndsWithZ)
        {
            // Last should be 'Z' (0x005A)
            Assert::AreEqual(static_cast<uint32_t>(0x005A), MatrixRain::CharacterConstants::LATIN_UPPERCASE_CODEPOINTS[25]);
        }
        ...
        TEST_METHOD(LatinUppercaseCodepoints_IsSequential)
        {
            ...
            for (size_t i = 0; i < 26; i++)
            {
                ...
                Assert::AreEqual(expected, MatrixRain::CharacterConstants::LATIN_UPPERCASE_CODEPOINTS[i]);
            }
        }
        ...
        TEST_METHOD(LatinLowercaseCodepoints_HasCorrectCount)
        {
            ...
            Assert::AreEqual(static_cast<size_t>(26), MatrixRain::CharacterConstants::LATIN_LOWERCASE_COUNT);
        }

        TEST_METHOD(LatinLowercaseCodepoints_StartsWithSmallA)
        {
            // First should be 'a' (0x0061)
            Assert::AreEqual(static_cast<uint32_t>(0x0061), MatrixRain::CharacterConstants::LATIN_LOWERCASE_CODEPOINTS[0]);
        }

        TEST_METHOD(LatinLowercaseCodepoints_EndsWithSmallZ)
        {
            // Last should be 'z' (0x007A)
            Assert::AreEqual(static_cast<uint32_t>(0x007A), MatrixRain::CharacterConstants::LATIN_LOWERCASE_CODEPOINTS[25]);
        }
        ...
        TEST_METHOD(LatinLowercaseCodepoints_IsSequential)
        {
            ...
            for (size_t i = 0; i < 26; i++)
            {
                ...
                Assert::AreEqual(expected, MatrixRain::CharacterConstants::LATIN_LOWERCASE_CODEPOINTS[i]);
            }
        }
        ...
        TEST_METHOD(NumeralCodepoints_HasCorrectCount)
        {
            ...
            const uint32_t* arr = MatrixRain::CharacterConstants::NUMERAL_CODEPOINTS;
        ...
        TEST_METHOD(NumeralCodepoints_StartsWithZero)
        {
            ...
            Assert::AreEqual(static_cast<uint32_t>(0x0030), MatrixRain::CharacterConstants::NUMERAL_CODEPOINTS[0]);
        }

        TEST_METHOD(NumeralCodepoints_EndsWithNine)
        {
            // Last should be '9' (0x0039)
            Assert::AreEqual(static_cast<uint32_t>(0x0039), MatrixRain::CharacterConstants::NUMERAL_CODEPOINTS[9]);
        }
        ...
        TEST_METHOD(NumeralCodepoints_IsSequential)
        {
            ...
            for (size_t i = 0; i < 10; i++)
            {
                ...
                Assert::AreEqual(expected, MatrixRain::CharacterConstants::NUMERAL_CODEPOINTS[i]);
            }
        }

        TEST_METHOD(GetAllCodepoints_ReturnsCorrectTotalCount)
        {
            std::vector<uint32_t> all = MatrixRain::CharacterConstants::GetAllCodepoints();

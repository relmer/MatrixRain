...
| Version | Highlights |
| :---: | :--- |
| **1.4** | GPU adapter selection, live multi-monitor toggle, frame cap on >60 Hz displays, Quality presets (Low/Medium/High/Custom) with per-knob infotips, PDH-backed GPU% stat, themed two-column dialog overhaul |
